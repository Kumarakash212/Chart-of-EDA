...
page=st.sidebar.radio("Select Page:",["Welcome","Univariate Analysis","Bivariate Analysis","Multivariate Analysis"], key="navigation")

# Welcome Page
if page=="Welcome":
    st.title("Welcome to the Data Analysis Application 🎉")
    st.write("""
             This application is designed for dynamic data visualization and analysis using your uploaded dataset.It support:
             
             - **Univariate Analysis:** Single-Variable exploration.
             - **Bivariate Analysis:** Explore relationship between two variable.
             - **Multivariate Analysis:** Advance insights involving multiple variables.
             
             ### Features include:
             - Interactive visualizations.
             - Seamless data uploaded and processing.
             - Advanced plots with costom options.
...
if page=="Univariate Analysis":
    ...
    st.write("Explore univariate plots with dynamic column selections.")


    # create a 2 * 2 subplots layout with increased  figure width
    ...
    if categorical_columns:              
        ...
        sns.countplot(data=data, x=count_col, ax=axes[0,0])
        axes[0,0].set_title(f"Countplot of {count_col}",fontsize=30, color='red',weight='bold')
    ...
    if categorical_columns:
        ...
        axes[1,0].set_title(f"Pie Chart of Top 5 category in {pie_col}", fontsize=30, color="red", weight="bold")
...
# Bivariate Analysis
    ...
    st.write("Explore bivariate relatioship with dynamic column selections.")    


    # Create a 3*2 subplot layout with increased figure width
    fig, axes=plt.subplots(2,2, figsize=(22,13))
    ...
    # Boxplot
    box_x=st.selectbox("x for boxplot (Categorical):",categorical_columns, key='box_x', index=0)
    box_y=st.selectbox("y for box plot (Numeric):", numeric_columns, key='box_y', index=0)
...
# Multivariate Analysis
    ...
    if numeric_columns:
        ...
        st.error("No numeric columns availabale for pairplot.")
